  ...
  state: {
    ...
    services: [
...

      {
        ...
        slug: "erp-services",
        p: `Digital solutions refer to technology-based tools and services designed to enhance processes, improve efficiency, and solve specific problems in various sectors. These solutions leverage digital technology to create streamlined workflows, facilitate communication, and foster innovation.`,
        sub_title_1: `
                Digital Business Solution is sub-directory of Green IT Co.,Ltd. Our solutions offer:
                `,
        list_one: [
        ...
        erp_title: `Enterprise Resource Planning`,
        erp_sub_title_1: `Enterprise Resource Planning , By integrating every department into one centralized system, ERPs streamline workflows, enhance productivity, boost throughput and reduce costs. From the top floor to the shop floor, ERPs give you greater insight and visibility into your operation, making your business run smoother and more efficiently.`,
        list_two: null,
        img: require("@/assets/images/icon/expert.png"),
        banner_img: require("@/assets/images/Digital Business Solution.jpg"),
        preview_img: require("@/assets/images/erp/benefits.webp"),

        erp_image1:require("@/assets/images/erp/odoo logo.png"),
        erp_image2:require("@/assets/images/erp/saleforce.png"),
        erp_image3:require("@/assets/images/erp/ecommerce.png"), 
        erp_image4:require("@/assets/images/erp/easy solution.png"),
        erp_image5:require("@/assets/images/erp/customized_solution.png"),

        erp_odoo_image1:require("@/assets/images/erp/odoo icon/accounting.png"),
        erp_odoo_image2:require("@/assets/images/erp/odoo icon/crm.png"),
        erp_odoo_image3:require("@/assets/images/erp/odoo icon/pos-terminal.png"), 
        erp_odoo_image4:require("@/assets/images/erp/odoo icon/hrm.png"),
        erp_odoo_image5:require("@/assets/images/erp/odoo icon/shopping-cart.png"),
        erp_odoo_image6:require("@/assets/images/erp/odoo icon/sales.png"),
        erp_odoo_image7:require("@/assets/images/erp/odoo icon/inventory.png"),
        erp_odoo_image8:require("@/assets/images/erp/odoo icon/factory.png"),
        erp_odoo_image9:require("@/assets/images/erp/odoo icon/email.png"),

        erp_other_odooimage1:require("@/assets/images/erp/odoo icon/restaurant-building.png"),
        erp_other_odooimage2:require("@/assets/images/erp/odoo icon/learning.png"),
        erp_other_odooimage3:require("@/assets/images/erp/odoo icon/knowledge.png"), 
        erp_other_odooimage4:require("@/assets/images/erp/odoo icon/factory.png"),
        erp_other_odooimage5:require("@/assets/images/erp/odoo icon/project-manager.png"),

      },
      // data center maintainance
      {
        title: "Data Center Maintainance",
        slug: "data-center-maintainance-services",
        p: `A data center maintenance solution involves a comprehensive strategy of regular inspections, cleaning, monitoring, testing, repairs, and equipment lifecycle management to ensure optimal performance and prevent costly outages, including routine checks of electrical, cooling systems, and hardware components like servers and network devices, often utilizing automated monitoring tools for proactive maintenance and reporting. `,  
        sub_title_1: `Data center maintenance solution:`,
        list_one: [
          "Regular Inspections",
        ...
        sub_title_2: `Scope OF Services`,
        list_two: [
          'Electrical Systems Maintenance',
          'Cooling System Maintenance',
          'Communications Cabling Maintenance',
          'Emergency Maintenance',
          'Network & Security Maintenance',
          'Storage & Server Maintenance',
          'Service Deliverable',
          'Outsources Maintenance Benefit',
          'Implementation Plan',
          'Service Level Agreement (SLA) Options'
        ],

        img: require("@/assets/images/icon/expert.png"),
        banner_img: require("@/assets/images/data-center-maintainance/banner.jpg"),
        preview_img: require("@/assets/images/data-center-maintainance/preview_image.webp"),
      },

       // data center colocation
       {
        title: "Data Center Colocation",
        slug: "data-center-colocation",
        p: `Our colocation service is a type of data centre provide equipment, space, and bandwidth are available for rental to retail customers. Colocation facilities provide space, power, cooling, and physical security for the server, storage, and networking equipment of other firms and also connect them to a variety of telecommunications and network service providers with a minimum of cost and complexity.`,  
        sub_title_1: `
                Server Rental Colo Service:
                `,
        list_one: [
          "Full Rack Colo",
          "Half Rack Colo",
        ...
        sub_title_2: `Server Rental Colo Facility`,
        list_two: [
          'ISP Redundant Connectivity',
          'Secure By Enterprise Firewall',
        ...
        sub_title_3: `Server Rental Colo SLA`,
        list_three: [
        ...
        img: require("@/assets/images/icon/expert.png"),
        banner_img: require("@/assets/images/colocation/banner.png"),
        preview_img: require("@/assets/images/colocation/preview_img.png"),
